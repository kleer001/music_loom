...
World and historical traditions read along three axes: **tuning** (how pitch is specified), **instrumentation** (what makes the sound), and **performance structure** (how a piece unfolds and who plays what when). The aim is a map of what a procedural instrument can and cannot express, not a buildable spec for any one tradition.

Every file uses the same three numbered sections.
